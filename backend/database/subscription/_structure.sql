/**
 * @schema subscription
 * Contains tables for managing accounts (tenants), subscriptions, and billing information.
 */
 ...
 * @multitenancy false (This is the root table for tenancy)
 * @softDelete true
 * @alias acc
 */
 ...
 * @type Search
 * @unique true
 * @filter Ensures account names are unique for active accounts.
 */
